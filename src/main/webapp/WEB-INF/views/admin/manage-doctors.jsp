...
<section class="grid-two">
    <div class="card">
        ...
        <h2 class="section-title"><%= editingDoctor == null ? "Add Doctor" : "Edit Doctor" %></h2>
        ...
        <form method="post" action="<%= request.getContextPath() %><%= editingDoctor == null ? "/admin/add-doctor" : "/admin/update-doctor" %>" class="grid-form">
            ...
            <div class="form-group full-span">
                ...
                <input type="text" name="availableDays" value="<%= editingDoctor == null ? "" : editingDoctor.getAvailableDays() %>">
            </div>
            <% if (editingDoctor != null) { %>
            <div class="form-group full-span">
